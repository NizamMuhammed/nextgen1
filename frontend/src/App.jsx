    ...
    <Router>
      <div className="min-h-screen flex flex-col relative overflow-hidden">
        ...
        <main className="flex-1 w-full max-w-7xl mx-auto px-4 py-6 relative z-10">
          <Routes>
            <Route path="/" element={<Home onAddToCart={handleAddToCart} isLoggedIn={!!user} promptLogin={promptLogin} token={token} />} />
            <Route path="/search" element={<Search onAddToCart={handleAddToCart} isLoggedIn={!!user} promptLogin={promptLogin} />} />
            <Route path="/product/:productId" element={<ProductDetails onAddToCart={handleAddToCart} isLoggedIn={!!user} promptLogin={promptLogin} token={token} />} />
            <Route path="/cart" element={<Cart cart={cart} onRemove={handleRemoveFromCart} isLoggedIn={!!user} promptLogin={promptLogin} />} />
            <Route
              path="/checkout"
              element={
                <ProtectedRoute>
                  <Checkout cart={cart} token={token} />
                </ProtectedRoute>
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <ProtectedRoute>
                  <UiWishlist isLoggedIn={!!user} promptLogin={promptLogin} />
                </ProtectedRoute>
              }
            />
