        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-glass-muted hover:text-glass transition-colors duration-200 p-2 rounded-lg hover:bg-white/10 glass-hover">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#" className="text-glass-muted hover:text-glass transition-colors duration-200 block py-1">
                  Home
                </a>
              </li>
              <li>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-glass">Stay Updated</h4>
        ...
        <div className="border-t border-white/10 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <a href="#" className="text-glass-muted hover:text-glass transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="text-glass-muted hover:text-glass transition-colors duration-200">
                Terms of Service
